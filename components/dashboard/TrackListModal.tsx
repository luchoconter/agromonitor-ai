...
import { X, Trash2, MapPin, User as UserIcon, Calendar, Clock, RotateCcw } from 'lucide-react';
...
export const TrackListModal: React.FC<TrackListModalProps> = ({ isOpen, onClose, tracks, users, fields, onTrackDeleted }) => {
    ...
    const handleDelete = async (trackId: string) => {
        if (!confirm('¿Estás seguro de que deseas eliminar este recorrido?')) return;
