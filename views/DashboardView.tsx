        ...
        <Modal isOpen={!!selectedSummary} onClose={() => setSelectedSummary(null)} title="Detalle de Estado">
          {selectedSummary && (
              <div className="space-y-4">
                  ...
                  <div className={`p-3 rounded-lg text-center font-bold uppercase text-sm border ${
                      (selectedSummary.engineerStatus || selectedSummary.status) === 'verde' ? 'bg-green-100 text-green-700 border-green-200' :
